...
type Repository struct {
	// total ordering
	messages       []WriteConsistencyMessageJSON
	messages_dedup map[string]bool
...
func (r *Repository) AppendMessage(wr_cons_msg WriteConsistencyMessageJSON) {
...
var repository = Repository{[]WriteConsistencyMessageJSON{{"none", 0, 0}}, map[string]bool{}, StagingRepository{}}
